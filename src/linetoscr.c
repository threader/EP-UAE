...
static int NOINLINE linetoscr_8_stretch2 (int spix, int dpix, int stoppos)
{
    uae_u8 *buf = (uae_u8 *) xlinebuffer;
    ...
    if (dp_for_drawing->ham_seen) {
        while (dpix < stoppos) {
            ...
            spix++;
            out_val = dpix_val;
            *((uae_u32 *)&buf[dpix]) = (uae_u32) out_val;
            dpix += 4;
        }
    } else if (bpldualpf) {
        int *lookup = bpldualpfpri ? dblpf_ind2 : dblpf_ind1;
...
static int NOINLINE linetoscr_8_shrink1f (int spix, int dpix, int stoppos)
{
    uae_u8 *buf = (uae_u8 *) xlinebuffer;
...
static int NOINLINE linetoscr_8_shrink2f (int spix, int dpix, int stoppos)
{
    uae_u8 *buf = (uae_u8 *) xlinebuffer;
    ...
    if (dp_for_drawing->ham_seen) {
        while (dpix < stoppos) {
            ...
            tmp_val3 = dpix_val;
            dpix_val = xcolors[ham_linebuf[spix]];
            tmp_val = merge_2pixel8 (tmp_val, tmp_val2);
            tmp_val2 = merge_2pixel8 (tmp_val3, dpix_val);
            dpix_val = merge_2pixel8 (tmp_val, tmp_val2);
            spix++;
            }
            out_val = dpix_val;
            buf[dpix++] = out_val;
...
static int NOINLINE linetoscr_8_spr (int spix, int dpix, int stoppos)
{
    uae_u8 *buf = (uae_u8 *) xlinebuffer;
    uae_u8 sprcol;
...
static int NOINLINE linetoscr_8_stretch1_spr (int spix, int dpix, int stoppos)
{
    uae_u8 *buf = (uae_u8 *) xlinebuffer;
    uae_u8 sprcol;
...
static int NOINLINE linetoscr_8_stretch2_spr (int spix, int dpix, int stoppos)
{
    uae_u8 *buf = (uae_u8 *) xlinebuffer;
    uae_u8 sprcol;
...
static int NOINLINE linetoscr_8_shrink1_spr (int spix, int dpix, int stoppos)
{
    uae_u8 *buf = (uae_u8 *) xlinebuffer;
    uae_u8 sprcol;
...
static int NOINLINE linetoscr_8_shrink1f_spr (int spix, int dpix, int stoppos)
{
    uae_u8 *buf = (uae_u8 *) xlinebuffer;
    uae_u8 sprcol;
...
static int NOINLINE linetoscr_8_shrink2_spr (int spix, int dpix, int stoppos)
{
    uae_u8 *buf = (uae_u8 *) xlinebuffer;
    uae_u8 sprcol;
...
static int NOINLINE linetoscr_8_shrink2f_spr (int spix, int dpix, int stoppos)
{
    uae_u8 *buf = (uae_u8 *) xlinebuffer;
    uae_u8 sprcol;
